package com.makemoney.earncash.freecash.screens
...
class GameActivity : BaseActivity(), Runnable {
    ...
    private var chances: Array<Float> = arrayOf(
            0.02f, 0.04f, 0.06f, 0.04f, 0.02f,
            0.06f, 0.02f, 0.04f, 0.02f,
            0.06f, 0.08f, 0.06f,
            0.08f, 0.04f,
            0.10f)
    ...
    private fun showItem(position: Int) {
        ...
        animationsManager.scale(tickets[position], 0.05f, 150L, {}, {
            ...
            tickets[position].setImageDrawable(resources.getDrawable(when (chance) {
                0.02f -> R.drawable.ticket_2
                0.04f -> R.drawable.ticket_4
                0.06f -> R.drawable.ticket_6
                0.08f -> R.drawable.ticket_8
                0.10f -> R.drawable.ticket_10
                else -> 0
            }))
            animationsManager.scale(tickets[position], 1f, 150L, {}, {
                ...
                updateCoins()
                dialogsManager.showAlertDialog(supportFragmentManager, "You got: $${format(chance)}!", {
                    hideItem(current)
