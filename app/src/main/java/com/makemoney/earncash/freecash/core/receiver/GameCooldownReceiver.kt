package com.makemoney.earncash.freecash.core.receiver
...
import com.makemoney.earncash.freecash.screens.GameActivity
...
class GameCooldownReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        nm.notify(0, NotificationCompat.Builder(context).setContentTitle(context.getString(R.string.app_name))
                .setContentText("Time to play! Tickets cooldown finished!").setSmallIcon(R.drawable.logo)
